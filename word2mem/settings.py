"""
Django settings for word2mem project.
...
SECRET_KEY = '=()-h=!vysh$5psne=x5kwv)pcm8*rg8@16+ftu#8crxffc#ug'
...
WSGI_APPLICATION = 'word2mem.wsgi.application'
